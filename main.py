...
class DetectorMaos:
    ...
    def encontrar_pontos(self, imagem, mao_num=0, desenho=True, cor=(255, 0, 255), raio=5):
        lista_pontos = []
        ...
        if self.resultado.multi_hand_landmarks:
            ...
            for id, ponto in enumerate(mao.landmark):
                ...
                # desenhar TODOS os pontos (opcional)
                if desenho:
                    cv2.circle(imagem, (cx, cy), raio, cor, cv2.FILLED)
